...
const Contact = () => {
  return (
    <div className="section-padding bg-soft-beige font-sans">
          ...
          <Card className="bg-white shadow-lg hover-lift">
            ...
            <CardContent>
              <form className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-rust-orange hover:bg-gold text-white transition-colors duration-300 hover-grow">Send Message</Button>
              </form>
            </CardContent>
          </Card>
        </div>
