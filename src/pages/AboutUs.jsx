...
const AboutUs = () => {
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold mb-8 text-center text-green-800">About Agro L'onious</h1>
      
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-4 text-green-700">Company Background</h2>
        <p className="mb-4">
