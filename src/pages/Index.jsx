      ...
      <section className="bg-gradient-to-r from-earth-green to-olive-green py-20 section-padding">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-4 text-white font-handwritten">Welcome to Agro L'onious</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 card-padding">
              <Target className="h-8 w-8 mx-auto mb-4 text-earth-green" />
            ...
            <div className="text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 card-padding">
              <Leaf className="h-8 w-8 mx-auto mb-4 text-earth-green" />
            ...
            <div className="text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 card-padding">
              <Sprout className="h-8 w-8 mx-auto mb-4 text-earth-green" />
          ...
          <div className="max-w-3xl mx-auto">
            <ul className="space-y-4">
              <li className="flex items-center bg-soft-beige p-4 rounded-lg shadow-sm">
                <History className="h-6 w-6 mr-4 text-gold" />
